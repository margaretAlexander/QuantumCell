...
parser$add_argument("--dataset_name", help = "Name of the dataset to run metacell on")
parser$add_argument("--filter_lateral", help = "Whether lateral genes were filtered in metacell")
